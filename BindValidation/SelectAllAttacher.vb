...
Public Class SelectAllAttacher
    ...
    Public Shared ReadOnly SelectAllTextOnFocusProperty As DependencyProperty = DependencyProperty.RegisterAttached("SelectAllTextOnFocus", GetType(Boolean), GetType(SelectAllAttacher), New UIPropertyMetadata(False, AddressOf OnSelectAllTextOnFocusChanged))
    ...
    Private Shared Sub OnSelectAllTextOnFocusChanged(ByVal d As DependencyObject, ByVal e As DependencyPropertyChangedEventArgs)
        ...
        If TypeOf e.NewValue Is Boolean = False Then Return
    ...
    Private Shared Sub IgnoreMouseButton(ByVal sender As Object, ByVal e As System.Windows.Input.MouseButtonEventArgs)
        ...
        If textBox Is Nothing OrElse textBox.IsKeyboardFocusWithin Then Return
        e.Handled = True
        textBox.Focus()
    End Sub
End Class
